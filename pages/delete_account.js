    ...
    return (
        <div>
            <div className="banner">
                <img src="/images/walking_away.jpeg" alt="Banner Image"/>
            </div>
            <div className="page">
                <div className="content">
                    ...
                    <p className="delete-paragraph">
                        ...
                        for you,
                        and we want to assure you that your choice is respected. We're here to support you throughout
                        this
                        process. If you choose to delete your account, please know that we will also remove any posts
                        you've
                        made and comments you've left on other users' posts, we value your data privacy. This way, you
                        can have
                        a fresh start if you decide to return in the future. Your contributions were valuable, and we
                        want to
                        express our gratitude for being a part of our community. Should you ever change your mind or
                        need
                        assistance, we'll be here to welcome you back or help in any way we can.
                    </p>
                    ...
                    <div className="delete-confirm">
                        <label className="delete-confirm-label">
                            ...
                            <span
                                className="delete-confirm-text">I understand the consequences of deleting my account.</span>
                        </label>
                    </div>
